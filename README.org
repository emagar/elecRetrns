...
<sup><sub>2026-08-20</sub></sup> Added a *research note* describing the *municipal elections* portion of the dataset [[./papers/data-descriptives/deep-description-07.pdf][here]]. 
And [[https://emagar.github.io/municipio-repo/][this]] web page now offers direct links to the files from this repository that are discussed in the research note.    

<sup><sub>2026-07-30</sub></sup> New file added: Tlaxcala's presidencias de comunidad elections (pseudo-regidores elected in SMDs) since 2013 [[./data/ay-nonfused/tla-pres-com-2013-on.csv][here]]. 

# <sup><sub>2025-12-06</sub></sup> New file added: municipal election *concurrence* with other races since 1989 [[conc][here]].
...
* Description paper
A research note describing the municipal portion of the data (with general relevance to other data in the repository) can be found [[./papers/data-descriptives/deep-description-07.pdf][here]].
...
- [[./data/aymu1989-on.concurrence.csv][~data/aymu1989-on.concurrence.csv~]] = indicators of municipal election concurrence with a gubernatorial, a state assembly, a presidential, or a congressional race since 1989.<<conc>>
...
Thank you to [[https://github.com/pedromezaq][Pedro Meza Quintanilla]] for pull requests that have updated and fixed bugs in the data. 
...
- [[https://github.com/LeonAzul][Arián Montiel]]
- [[https://github.com/cblanes][Camila Blanes]]
- [[https://github.com/calexissarabia][Carlos Alexis Sarabia Melgarejo]]
- Daniela Guzmán Lerma
- Eugenio Solís Flores
- [[https://github.com/franciscocantu][Francisco Cantú]]
- [[http://franciscogarfias.com/][Francisco Garfias]]
- Gabino Martínez Díaz
- [[https://github.com/ips03][Isaac Palatto Sánchez]]
...
- [[https://github.com/razoR-28][Rodrigo Santibáñez Razo]]
