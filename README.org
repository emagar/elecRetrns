...
(/Ayuntamientos/) data updated to 2022. Other than in Nayarit since 2008 (and, pending a court case, Mexico City since 2018), /ayuntamientos/ are elected in fused ballots for a /presidente municipal/ and a fraction of the municipal council (/regidores/ and /síndicos/). Nayarit elects these members of the municipal council in single-member plurality districts called /demarcaciones/. Two versions of these returns are included (the script [[./code/ay.r][~code/ay.r~]] was used to manipulate raw /ayuntamiento/ returns, not distributed):
# Ojo 2023-05-29: check status of CdMx in paragraph above.
- [[./data/aymu1989-present.coalAgg.csv][~data/aymu1970-on.coalAgg.csv~]] = coalition votes appear properly aggregated by candidate.
- [[./data/aymu1989-present.coalSplit.csv][~data/aymu1970-on.coalSplit.csv~]] = coalition votes appear properly split among its members.
...
- You can *inspect the data above online*, in Google sheets (basic instructions [[instrucciones][here]]; data split by approximate decades or groups of states to comply with Google's maximum spreadsheet size (400k cells); files have identical columns to ease appending one another off Google drive):
    ...
    - ~incumbents~: [[https://docs.google.com/spreadsheets/d/1lgJJ2f8O_MHe18q3OekRylgxOXpKGrcm6ABQPVhmlf4/copy][Aguascalientes (1) to Nuevo León (19)]] [[https://docs.google.com/spreadsheets/d/1ZabVHORN0uOU8AX7bZGiQY1JEhncG6SodLfn6DXW4zQ/copy][Oaxaca (20) to Zacatecas (32)]]
- [[./data/ayde2008-presentNayRegid.csv][~data/ayde2008-on-Nayarit-regid.csv~]] = Nayarit's municipal demarcaciones vote returns since 2008.
