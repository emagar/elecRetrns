...
- ~data/prdf2006-on.csv~
  + *Citation for this dataset*: Eric Magar (2012) Gubernatorial Coattails in Mexican Congressional Elections, /The Journal of Politics/ 74(2):383-399.
- ~datosBrutos/~ = directory containing selected primary sources. Files for state elections were dropped from the repository due sizes above github's limit... [[mailto:emagar@itam.mx][mail me]] if you need these.
