...
*Letters of intent* of running (/cartas de intención/, see [[http://eleccionconsecutiva.diputados.gob.mx/contendientes][this]]) for reelection now systematized in ~data/dfdf1997-present.incumbents.csv~. See codebook below.
