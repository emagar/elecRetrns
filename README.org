...
- /race.after/ = incumbent's status in the subsequent race. See [[status-rules][this]] for categories and coding rules (y [[status-rules-esp][esto]] para la versión en español de las reglas). 
