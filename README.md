- [Description of *Recent Mexican Election Vote Returns* repository](#orgfa1c9d8)
- [Files in the repository and how to cite them](#orgb8a8441)
- [Codebook](#org5d97251)
- [Coding procedure for the incumbent's status<a id="org60ed21b"></a>](#org8486c55)
- [Procedimiento para codificar el estatus del ocupante<a id="orgf401e52"></a>](#org9b5b680)
- [Sources](#orgb33ccd0)
- [Acknowledgements](#org5c05333)
...
-   *race.after* = incumbent's status in the subsequent race. See [this](#org60ed21b) for categories and coding procedure ([aquí](#orgf401e52) la versión en español del procedimiento codificador).
...
# Coding procedure for the incumbent's status<a id="org60ed21b"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="orgf401e52"></a>
