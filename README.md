- [Description of *Recent Mexican Election Vote Returns* repository](#org543e0e9)
- [Files in the repository and how to cite them](#org94853f6)
- [Codebook](#org8d8081c)
- [Coding procedure for the incumbent's status<a id="org488cfe6"></a>](#org04e19da)
- [Procedimiento para codificar el estatus del ocupante<a id="org7d16def"></a>](#org11bb4b9)
- [Sources](#org6a6c29b)
- [Acknowledgements](#org274cd5b)
...
-   [`data/aymu1970-on.csv`](./data/aymu1989-present.csv) = updated to 2022, can be processed with code/ay.r in order to systematize coalitions (ie., aggregate votes when member parties' returns are reported separately and remove redundant columns).
    -   Inspect data online in Google sheets: coalitions aggregated by candidate [here](https://emagar.github.io/view-in-gSheets/::aymu_cand).
...
-   *race.after* = incumbent's status in the subsequent race. See [this](#org488cfe6) for categories and coding procedure ([aquí](#org7d16def) la versión en español del procedimiento codificador).
...
# Coding procedure for the incumbent's status<a id="org488cfe6"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="org7d16def"></a>
