- [Description of *Recent Mexican Election Vote Returns* repository<a id="orga3bfe7a"></a>](#orgc2f265f)
- [How to cite the data](#orga5fd472)
- [Description paper](#orgd708e70)
- [File naming conventions](#org09e8b9c)
- [Files in the repository](#orga789b2a)
  - [Municipal office election returns](#org826633d)
    - [Non-fused ballots (Chihuahua and Nayarit)](#orga9e6156)
    - [**Inspect data online** in Google sheets](#orgdd4ad03)
  - [Congressional election returns](#org41f12ff)
  - [Presidential election returns](#org9439776)
  - [Gubernatorial election returns](#org15106ea)
  - [Other](#orgc3d028d)
- [Historical party performance statistics](#org4d63504)
  - [Backwards predictions](#orgb706c40)
- [Codebook<a id="orga0a019a"></a>](#org0779c84)
  - [Unit IDs](#orgc6588e7)
  - [Temporal IDs](#org7b40e34)
  - [Voting](#org4f6d342)
  - [Historical performance](#orgb6c7fee)
  - [Candidates and incumbents](#orgbfef028)
  - [Other](#org613acf0)
- [Coding procedure for the incumbent's status<a id="orgec077a5"></a>](#org18525fe)
- [Procedimiento para codificar el estatus del ocupante<a id="orgce6b912"></a>](#orge40b11f)
- [Basic instructions to inspect data online:<a id="org4fb82f0"></a>](#org2bbe59a)
- [Sources](#orgc95a5c8)
- [Acknowledgements](#org1a65167)
...
<sup><sub>2025-12-11</sub></sup> A research note describing the municipal elections portion of the data [here](./papers/data-descriptives/deep-description-04-mex-studies.pdf).

<sup><sub>2025-12-06</sub></sup> Added new file with election **concurrence** with other races data since 1989 [here](#org4d53ae1).

<sup><sub>2025-06-02</sub></sup> Added returns and winners for 2025 municipal elections in Durango and Veracruz.
...
# Description of *Recent Mexican Election Vote Returns* repository<a id="orga3bfe7a"></a>
...
A research note describing the municipal portion of the data (with general relevance to other data in the repository) can be found [here](./papers/data-descriptives/deep-description-04-mex-studies.pdf).
...
-   [`data/aymu1989-on.concurrence.csv`](./data/aymu1989-on.concurrence.csv) = indicators of municipal election concurrence with a gubernatorial, a state assembly, a presidential, or a congressional race since 1989.<a id="org4d53ae1"></a>
...
Basic instructions [here](#org4fb82f0); data split by approximate decades or groups of states to comply with spreadsheet size limits (400k cells); files have identical columns to ease appending one another off Google drive:
...
-   **Inspect the data above online** in Google sheets (basic instructions [here](#org4fb82f0)):
...
[<sub>Back to top</sub>](#orga3bfe7a)
...
-   *race.after* = incumbent's status in the next consecutive race. See [this](#orgec077a5) for categories and coding procedure ([aquí](#orgce6b912) la versión en castellano del procedimiento codificador).
...
# Coding procedure for the incumbent's status<a id="orgec077a5"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="orgce6b912"></a>
...
# Basic instructions to inspect data online:<a id="org4fb82f0"></a>
...
c. Linked data updates about every hour. If a refresh were needed sooner, erase the function in cell A1 and undo the change. [<sub>Back to top</sub>](#orga3bfe7a)
