- [Description of *Recent Mexican Election Vote Returns* repository<a id="org5ba4674"></a>](#org27a30c5)
- [Files in the repository](#org2d77e65)
  - [how to cite the data](#org0cc6a74)
  - [File naming conventions](#orgcb551f1)
  - [Municipal office election returns](#orge0922cc)
  - [Congressional election returns](#org7bd7d5f)
  - [Presidential election returns](#orge478e1d)
  - [Gubernatorial election returns](#orgef1ec29)
  - [Other](#orgc85ffbb)
- [Historical party performance statistics](#orga74261c)
  - [Backwards predictions](#orgad582a8)
- [Codebook<a id="orgbf2f739"></a>](#org8edeb3b)
  - [Unit IDs](#org6642c91)
  - [Temporal IDs](#org99b3f3c)
  - [Voting information](#org4e8a4bb)
  - [Historical performance](#orgb3a1a35)
  - [Candidate IDs](#orgd03bf48)
  - [Other](#org0787f88)
- [Coding procedure for the incumbent's status<a id="orga95d1e0"></a>](#org6c853b1)
- [Procedimiento para codificar el estatus del ocupante<a id="org0536b24"></a>](#org91a2e00)
- [Basic instructions to inspect data online:<a id="org69dfd61"></a>](#org37c4f32)
- [Sources](#orgf2f85b5)
- [Acknowledgements](#org5eec49c)
...
<sup><sub>2023-06-07</sub></sup> [**Codebook**](#orgbf2f739) updated, with a printable flier.
...
# Description of *Recent Mexican Election Vote Returns* repository<a id="org5ba4674"></a>
...
-   **Inspect the data above online** in Google sheets (basic instructions [here](#org69dfd61); data split by approximate decades or groups of states to comply with spreadsheet size limits (400k cells); files have identical columns to ease appending one another off Google drive):
...
-   **Inspect the data above online** in Google sheets (basic instructions [here](#org69dfd61)):
...
[<sub>Back to top</sub>](#org5ba4674)
...
-   *race.after* = incumbent's status in the next consecutive race. See [this](#orga95d1e0) for categories and coding procedure ([aquí](#org0536b24) la versión en castellano del procedimiento codificador).
...
# Coding procedure for the incumbent's status<a id="orga95d1e0"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="org0536b24"></a>
...
# Basic instructions to inspect data online:<a id="org69dfd61"></a>
...
c. Linked data updates about every hour. If a refresh were needed sooner, erase the function in cell A1 and undo the change. [<sub>Back to top</sub>](#org5ba4674)
