- [Description of *Recent Mexican Election Vote Returns* repository<a id="orgeb12863"></a>](#orge311f45)
- [How to cite the data](#org3b6069d)
- [Description paper](#org7a6640e)
- [File naming conventions](#org971a807)
- [Files in the repository](#org5a6cf4f)
  - [Municipal office election returns](#org861e904)
    - [Non-fused ballots (Chihuahua and Nayarit)](#org79e519b)
    - [**Inspect data online** in Google sheets](#org6eef7b5)
  - [Congressional election returns](#org4ab0d7b)
  - [Presidential election returns](#org05922a5)
  - [Gubernatorial election returns](#orge9ef358)
  - [Other](#org8f9e9aa)
- [Historical party performance statistics](#orge1e6bfd)
  - [Backwards predictions](#org3698a5d)
- [Codebook<a id="orgcf6a814"></a>](#orge59ea04)
  - [Unit IDs](#orgf0c199a)
  - [Temporal IDs](#org7614955)
  - [Voting](#org229c0ab)
  - [Historical performance](#org9b4333e)
  - [Candidates and incumbents](#org56199eb)
  - [Other](#org75a68e4)
- [Coding procedure for the incumbent's status<a id="orge83ed9f"></a>](#orgc66d1f5)
- [Procedimiento para codificar el estatus del ocupante<a id="orgdb71779"></a>](#org5b86b49)
- [Basic instructions to inspect data online:<a id="orgd15e006"></a>](#org901f19a)
- [Sources](#org49b998d)
- [Acknowledgements](#orgf5713a9)
...
<sup><sub>2025-12-06</sub></sup> Added new file with election **concurrence** with other races data since 1989 [here](#org611f7a0).
...
# Description of *Recent Mexican Election Vote Returns* repository<a id="orgeb12863"></a>
...
-   [`data/aymu1989-on.concurrence.csv`](./data/aymu1989-on.concurrence.csv) = indicators of municipal election concurrence with a gubernatorial, a state assembly, a presidential, or a congressional race since 1989.<a id="org611f7a0"></a>
...
Basic instructions [here](#orgd15e006); data split by approximate decades or groups of states to comply with spreadsheet size limits (400k cells); files have identical columns to ease appending one another off Google drive:
...
-   **Inspect the data above online** in Google sheets (basic instructions [here](#orgd15e006)):
...
[<sub>Back to top</sub>](#orgeb12863)
...
-   *race.after* = incumbent's status in the next consecutive race. See [this](#orge83ed9f) for categories and coding procedure ([aquí](#orgdb71779) la versión en castellano del procedimiento codificador).
...
# Coding procedure for the incumbent's status<a id="orge83ed9f"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="orgdb71779"></a>
...
# Basic instructions to inspect data online:<a id="orgd15e006"></a>
...
c. Linked data updates about every hour. If a refresh were needed sooner, erase the function in cell A1 and undo the change. [<sub>Back to top</sub>](#orgeb12863)
