- [Description of *Recent Mexican Election Vote Returns* repository<a id="org2fbdc76"></a>](#orga9ca7a3)
- [How to cite the data](#org97658bb)
- [File naming conventions](#orgc45d92a)
- [Files in the repository](#org66dea56)
  - [Municipal office election returns](#org8b33057)
  - [Congressional election returns](#orgb3a7f9c)
  - [Presidential election returns](#orgcf1ccf0)
  - [Gubernatorial election returns](#orgd599c2d)
  - [Other](#org37e46a7)
- [Historical party performance statistics](#orgae14b2e)
  - [Backwards predictions](#org72e98cc)
- [Codebook<a id="orgb3af161"></a>](#orgcdb453c)
  - [Unit IDs](#org8687b2d)
  - [Temporal IDs](#orga4a154c)
  - [Voting information](#orgce8084a)
  - [Historical performance](#org92e637e)
  - [Candidate IDs](#org72bbb26)
  - [Other](#org3773881)
- [Coding procedure for the incumbent's status<a id="org5b711d9"></a>](#orgc674a45)
- [Procedimiento para codificar el estatus del ocupante<a id="orga14fde0"></a>](#orgf7fc19a)
- [Basic instructions to inspect data online:<a id="orgac287f7"></a>](#org1b9409b)
- [Sources](#org129ddba)
- [Acknowledgements](#org1ca37fb)
...
<sup><sub>2023-06-07</sub></sup> [**Codebook**](#orgb3af161) updated, with a printable flier.
...
# Description of *Recent Mexican Election Vote Returns* repository<a id="org2fbdc76"></a>
...
-   **Inspect the data above online** in Google sheets (basic instructions [here](#orgac287f7); data split by approximate decades or groups of states to comply with spreadsheet size limits (400k cells); files have identical columns to ease appending one another off Google drive):
...
-   **Inspect the data above online** in Google sheets (basic instructions [here](#orgac287f7)):
...
[<sub>Back to top</sub>](#org2fbdc76)
...
# Codebook<a id="orgb3af161"></a>

Most variables are included in all files, some appear in selected files only. Printable version [here](./codebook-flier.pdf).
...
-   *race.after* = incumbent's status in the next consecutive race. See [this](#org5b711d9) for categories and coding procedure ([aquí](#orga14fde0) la versión en castellano del procedimiento codificador).
...
# Coding procedure for the incumbent's status<a id="org5b711d9"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="orga14fde0"></a>
...
# Basic instructions to inspect data online:<a id="orgac287f7"></a>
...
c. Linked data updates about every hour. If a refresh were needed sooner, erase the function in cell A1 and undo the change. [<sub>Back to top</sub>](#org2fbdc76)
