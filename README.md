- [Description of *Recent Mexican Election Vote Returns* repository<a id="org660f828"></a>](#org3b3ce3f)
- [How to cite the data](#orga235e9f)
- [Description paper](#org5d28bfc)
- [File naming conventions](#orgb2daf66)
- [Files in the repository](#org9900e53)
  - [Municipal office election returns](#org641f872)
    - [Non-fused ballots (Chihuahua and Nayarit)](#org2ea2d36)
    - [**Inspect data online** in Google sheets](#org06f942c)
  - [Congressional election returns](#org5fcd412)
  - [Presidential election returns](#org6b5f63c)
  - [Gubernatorial election returns](#org09e2e50)
  - [Other](#org77a9300)
- [Historical party performance statistics](#org0df0adb)
  - [Backwards predictions](#org743d6e5)
- [Codebook<a id="org830c909"></a>](#org5cd34c6)
  - [Unit IDs](#orgd91802e)
  - [Temporal IDs](#orgbb82056)
  - [Voting](#org50334a2)
  - [Historical performance](#org45e07e6)
  - [Candidates and incumbents](#orgf83e18f)
  - [Other](#org6095d34)
- [Coding procedure for the incumbent's status<a id="orge8d477b"></a>](#org8e47b99)
- [Procedimiento para codificar el estatus del ocupante<a id="org26e4281"></a>](#orge82d98e)
- [Basic instructions to inspect data online:<a id="orgb2d78fa"></a>](#orgaa48845)
- [Sources](#org4ad8cd4)
- [Acknowledgements](#orgcb4655f)
...
<sup><sub>2025-12-06</sub></sup> New file added: municipal election **concurrence** with other races since 1989 [here](#org9122a76).
...
# Description of *Recent Mexican Election Vote Returns* repository<a id="org660f828"></a>
...
-   [`data/aymu1989-on.concurrence.csv`](./data/aymu1989-on.concurrence.csv) = indicators of municipal election concurrence with a gubernatorial, a state assembly, a presidential, or a congressional race since 1989.<a id="org9122a76"></a>
...
Basic instructions [here](#orgb2d78fa); data split by approximate decades or groups of states to comply with spreadsheet size limits (400k cells); files have identical columns to ease appending one another off Google drive:
...
-   **Inspect the data above online** in Google sheets (basic instructions [here](#orgb2d78fa)):
...
[<sub>Back to top</sub>](#org660f828)
...
-   *race.after* = incumbent's status in the next consecutive race. See [this](#orge8d477b) for categories and coding procedure ([aquí](#org26e4281) la versión en castellano del procedimiento codificador).
...
# Coding procedure for the incumbent's status<a id="orge8d477b"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="org26e4281"></a>
...
# Basic instructions to inspect data online:<a id="orgb2d78fa"></a>
...
c. Linked data updates about every hour. If a refresh were needed sooner, erase the function in cell A1 and undo the change. [<sub>Back to top</sub>](#org660f828)
