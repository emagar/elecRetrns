- [Description of *Recent Mexican Election Vote Returns* repository](#orgb7478aa)
- [Files in the repository and how to cite them](#org2526e32)
- [Codebook](#orgb6dc5ad)
- [Coding procedure for the incumbent's status<a id="org0af33af"></a>](#orgb18b4a3)
- [Procedimiento para codificar el estatus del ocupante<a id="orgc8286cc"></a>](#orge2fc3db)
- [Sources](#org71feccb)
- [Acknowledgements](#org12ee3e5)

Last revision: 2022-08-12

---

**State-level presidential returns** cleaned and updated.
...
-   *race.after* = incumbent's status in the subsequent race. See [this](#org0af33af) for categories and coding procedure ([aquí](#orgc8286cc) la versión en español del procedimiento codificador).
...
# Coding procedure for the incumbent's status<a id="org0af33af"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="orgc8286cc"></a>
