- [Description of *Recent Mexican Election Vote Returns* repository<a id="orgc306d60"></a>](#org9a0af5b)
- [How to cite the data](#orgefd5892)
- [File naming conventions](#org57e0eb8)
- [Files in the repository](#orgbee92d0)
  - [Municipal office election returns](#orgfc5c2e8)
    - [Non-fused ballots (Chihuahua and Nayarit)](#org81f70ab)
    - [**Inspect data online** in Google sheets](#org0714892)
  - [Congressional election returns](#org8440c21)
  - [Presidential election returns](#orge204fad)
  - [Gubernatorial election returns](#org937cba6)
  - [Other](#org98005ff)
- [Historical party performance statistics](#org9132826)
  - [Backwards predictions](#org31c0d40)
- [Codebook<a id="org60ef783"></a>](#org1e2e0df)
  - [Unit IDs](#orgb67d551)
  - [Temporal IDs](#org591d7fc)
  - [Voting](#org8b47471)
  - [Historical performance](#org7009977)
  - [Candidates and incumbents](#org88fbea1)
  - [Other](#orgd0804d1)
- [Coding procedure for the incumbent's status<a id="org25a32bf"></a>](#org2bdf03f)
- [Procedimiento para codificar el estatus del ocupante<a id="org7f32723"></a>](#org6db0231)
- [Basic instructions to inspect data online:<a id="org7be3e53"></a>](#orgc91be34)
- [Sources](#orgd841b15)
- [Acknowledgements](#orgac8bf3e)
...
<sup><sub>2025-12-06</sub></sup> Added new file with election **concurrence** with other races data since 1989 [here](#org71542ca).
...
# Description of *Recent Mexican Election Vote Returns* repository<a id="orgc306d60"></a>
...
A research note describing the municipal portion of the data can be found [here](./papers/data-descriptives/deep-description-04-mex-studies.pdf).
...
-   [`data/aymu1989-on.concurrence.csv`](./data/aymu1989-on.concurrence.csv) = indicators of municipal election concurrence with a gubernatorial, a state assembly, a presidential, or a congressional race since 1989.<a id="org71542ca"></a>
...
Basic instructions [here](#org7be3e53); data split by approximate decades or groups of states to comply with spreadsheet size limits (400k cells); files have identical columns to ease appending one another off Google drive:
...
-   **Inspect the data above online** in Google sheets (basic instructions [here](#org7be3e53)):
...
[<sub>Back to top</sub>](#orgc306d60)
...
-   *race.after* = incumbent's status in the next consecutive race. See [this](#org25a32bf) for categories and coding procedure ([aquí](#org7f32723) la versión en castellano del procedimiento codificador).
...
# Coding procedure for the incumbent's status<a id="org25a32bf"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="org7f32723"></a>
...
# Basic instructions to inspect data online:<a id="org7be3e53"></a>
...
c. Linked data updates about every hour. If a refresh were needed sooner, erase the function in cell A1 and undo the change. [<sub>Back to top</sub>](#orgc306d60)
