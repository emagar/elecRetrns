- [Description of *Recent Mexican Election Vote Returns* repository<a id="org102216b"></a>](#orgc8767d3)
- [How to cite the data](#orgbf0f694)
- [File naming conventions](#orgcffe0f1)
- [Files in the repository](#org10b758e)
  - [Municipal office election returns](#org271fd1d)
    - [Non-fused ballots (Chihuahua and Nayarit)](#org8e5c904)
    - [**Inspect data online** in Google sheets](#org62f43b3)
  - [Congressional election returns](#orgc13fc38)
  - [Presidential election returns](#orgdaccc5a)
  - [Gubernatorial election returns](#orge8fe360)
  - [Other](#org4a68b5c)
- [Historical party performance statistics](#org4dbf0ef)
  - [Backwards predictions](#orga1729db)
- [Codebook<a id="org02f9bbb"></a>](#org51dcd5b)
  - [Unit IDs](#org0c196d0)
  - [Temporal IDs](#org761404a)
  - [Voting](#orgef22184)
  - [Historical performance](#orge0a1cab)
  - [Candidates and incumbents](#orgec06365)
  - [Other](#org97fcd01)
- [Coding procedure for the incumbent's status<a id="org988d90b"></a>](#org8d0e27e)
- [Procedimiento para codificar el estatus del ocupante<a id="org144b688"></a>](#orgdc9329e)
- [Basic instructions to inspect data online:<a id="org616029c"></a>](#org2782fb4)
- [Sources](#org0b220eb)
- [Acknowledgements](#org4a383dc)
...
<sup><sub>2023-11-11</sub></sup> [**Codebook**](#org02f9bbb) updated, with a printable flier.
...
# Description of *Recent Mexican Election Vote Returns* repository<a id="org102216b"></a>
...
Basic instructions [here](#org616029c); data split by approximate decades or groups of states to comply with spreadsheet size limits (400k cells); files have identical columns to ease appending one another off Google drive:
...
-   **Inspect the data above online** in Google sheets (basic instructions [here](#org616029c)):
...
[<sub>Back to top</sub>](#org102216b)
...
-   *race.after* = incumbent's status in the next consecutive race. See [this](#org988d90b) for categories and coding procedure ([aquí](#org144b688) la versión en castellano del procedimiento codificador).
...
# Coding procedure for the incumbent's status<a id="org988d90b"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="org144b688"></a>
...
# Basic instructions to inspect data online:<a id="org616029c"></a>
...
c. Linked data updates about every hour. If a refresh were needed sooner, erase the function in cell A1 and undo the change. [<sub>Back to top</sub>](#org102216b)
