- [Description of *Recent Mexican Election Vote Returns* repository](#org1d0f7b0)
- [Files in the repository and how to cite them](#orgdfd95ca)
- [Codebook](#orgd47c9b4)
- [Coding procedure for the incumbent's status<a id="org3ff0c4f"></a>](#org0f04e08)
- [Procedimiento para codificar el estatus del ocupante<a id="orgd91b6ca"></a>](#org4e9cb14)
- [Sources](#orgab67653)
- [Acknowledgements](#orgd90ff58)
...
-   *race.after* = incumbent's status in the subsequent race. See [this](#org3ff0c4f) for categories and coding procedure ([aquí](#orgd91b6ca) la versión en español del procedimiento codificador).
...
# Coding procedure for the incumbent's status<a id="org3ff0c4f"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="orgd91b6ca"></a>
