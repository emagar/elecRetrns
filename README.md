- [Description of *Recent Mexican Election Vote Returns* repository<a id="orga83e963"></a>](#org99b136a)
- [How to cite the data](#orgc2f76dc)
- [File naming conventions](#orgcb27af8)
- [Files in the repository](#org884d832)
  - [Municipal office election returns](#org1925eec)
    - [Non-fused ballots (Chihuahua and Nayarit)](#orgef35bcd)
    - [**Inspect data online** in Google sheets](#org23b0f2f)
  - [Congressional election returns](#orgd65e739)
  - [Presidential election returns](#org96eee87)
  - [Gubernatorial election returns](#org2b4c535)
  - [Other](#org1744ce9)
- [Historical party performance statistics](#orga08ec50)
  - [Backwards predictions](#org67b557a)
- [Codebook<a id="orgab8b8ce"></a>](#org9253e4c)
  - [Unit IDs](#org3b68f9a)
  - [Temporal IDs](#orgf4ad4b3)
  - [Voting](#org52dee6a)
  - [Historical performance](#orgaf5d980)
  - [Candidates and incumbents](#org49e1fb1)
  - [Other](#orgad600bd)
- [Coding procedure for the incumbent's status<a id="org166de4c"></a>](#org2cf8673)
- [Procedimiento para codificar el estatus del ocupante<a id="org319e315"></a>](#org7960e20)
- [Basic instructions to inspect data online:<a id="org3ac0b3c"></a>](#org3b73d41)
- [Sources](#org23bd32d)
- [Acknowledgements](#org151a27e)
...
<sup><sub>2023-11-11</sub></sup> [**Codebook**](#orgab8b8ce) updated, with a printable flier.
...
# Description of *Recent Mexican Election Vote Returns* repository<a id="orga83e963"></a>
...
Basic instructions [here](#org3ac0b3c); data split by approximate decades or groups of states to comply with spreadsheet size limits (400k cells); files have identical columns to ease appending one another off Google drive:
...
-   **Inspect the data above online** in Google sheets (basic instructions [here](#org3ac0b3c)):
...
[<sub>Back to top</sub>](#orga83e963)
...
-   *race.after* = incumbent's status in the next consecutive race. See [this](#org166de4c) for categories and coding procedure ([aquí](#org319e315) la versión en castellano del procedimiento codificador).
...
# Coding procedure for the incumbent's status<a id="org166de4c"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="org319e315"></a>
...
# Basic instructions to inspect data online:<a id="org3ac0b3c"></a>
...
c. Linked data updates about every hour. If a refresh were needed sooner, erase the function in cell A1 and undo the change. [<sub>Back to top</sub>](#orga83e963)
