- [Description of *Recent Mexican Election Vote Returns* repository<a id="orgb3f617d"></a>](#org599f710)
- [How to cite the data](#org8cfeb48)
- [Description paper](#orgf0e32bf)
- [File naming conventions](#org58bc602)
- [Files in the repository](#org9ebd447)
  - [Municipal office election returns](#org3c573c0)
    - [Non-fused ballots (Chihuahua and Nayarit)](#org82ef3f5)
    - [**Inspect data online** in Google sheets](#org0d3b60a)
  - [Congressional election returns](#orga40a893)
  - [Presidential election returns](#org72e1fd8)
  - [Gubernatorial election returns](#org13f673e)
  - [Other](#org2d81001)
- [Historical party performance statistics](#orgc4d40d9)
  - [Backwards predictions](#org5bf23d3)
- [Codebook<a id="orgf7e87b0"></a>](#orga8b21d3)
  - [Unit IDs](#org42a6132)
  - [Temporal IDs](#org52b72cb)
  - [Voting](#orgb1a02c3)
  - [Historical performance](#org35ba70f)
  - [Candidates and incumbents](#org729a6a9)
  - [Other](#org9f50ed7)
- [Coding procedure for the incumbent's status<a id="orgc0314e8"></a>](#org6cd2f10)
- [Procedimiento para codificar el estatus del ocupante<a id="org8907024"></a>](#org433c9ae)
- [Basic instructions to inspect data online:<a id="org1b341bb"></a>](#org94dca5e)
- [Sources](#org9d688bc)
- [Acknowledgements](#org2bced5c)
...
<sup><sub>2025-12-06</sub></sup> New file added: municipal election **concurrence** with other races since 1989 [here](#org0e117a4).
...
# Description of *Recent Mexican Election Vote Returns* repository<a id="orgb3f617d"></a>
...
-   [`data/aymu1989-on.concurrence.csv`](./data/aymu1989-on.concurrence.csv) = indicators of municipal election concurrence with a gubernatorial, a state assembly, a presidential, or a congressional race since 1989.<a id="org0e117a4"></a>
...
Basic instructions [here](#org1b341bb); data split by approximate decades or groups of states to comply with spreadsheet size limits (400k cells); files have identical columns to ease appending one another off Google drive:
...
-   **Inspect the data above online** in Google sheets (basic instructions [here](#org1b341bb)):
...
[<sub>Back to top</sub>](#orgb3f617d)
...
-   *race.after* = incumbent's status in the next consecutive race. See [this](#orgc0314e8) for categories and coding procedure ([aquí](#org8907024) la versión en castellano del procedimiento codificador).
...
# Coding procedure for the incumbent's status<a id="orgc0314e8"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="org8907024"></a>
...
# Basic instructions to inspect data online:<a id="org1b341bb"></a>
...
c. Linked data updates about every hour. If a refresh were needed sooner, erase the function in cell A1 and undo the change. [<sub>Back to top</sub>](#orgb3f617d)
