- [Description of *Recent Mexican Election Vote Returns* repository<a id="org191c71e"></a>](#org773cac4)
- [How to cite the data](#orgeba7f17)
- [File naming conventions](#org0c283d6)
- [Files in the repository](#org503fe93)
  - [Municipal office election returns](#org079592c)
    - [Non-fused ballots (Chihuahua and Nayarit)](#org58d3750)
    - [**Inspect data online** in Google sheets](#org684ffee)
  - [Congressional election returns](#org41ddbe0)
  - [Presidential election returns](#orgeda1ad3)
  - [Gubernatorial election returns](#orgd1210da)
  - [Other](#org4dd915d)
- [Historical party performance statistics](#org29cb4af)
  - [Backwards predictions](#orga28f078)
- [Codebook<a id="org45644a0"></a>](#org30492ca)
  - [Unit IDs](#orge6ccc6f)
  - [Temporal IDs](#orgcf77b04)
  - [Voting](#org16a2737)
  - [Historical performance](#org5ee2e71)
  - [Candidates and incumbents](#org7d74a1f)
  - [Other](#org95d7cd7)
- [Coding procedure for the incumbent's status<a id="orgdaa11ed"></a>](#orgd00b975)
- [Procedimiento para codificar el estatus del ocupante<a id="org0f0bf6a"></a>](#org76c1ce9)
- [Basic instructions to inspect data online:<a id="org9bfd28b"></a>](#orgc27c295)
- [Sources](#org09044dc)
- [Acknowledgements](#org877910d)
...
<sup><sub>2023-11-11</sub></sup> [**Codebook**](#org45644a0) updated, with a printable flier.
...
# Description of *Recent Mexican Election Vote Returns* repository<a id="org191c71e"></a>
...
Basic instructions [here](#org9bfd28b); data split by approximate decades or groups of states to comply with spreadsheet size limits (400k cells); files have identical columns to ease appending one another off Google drive:
...
-   **Inspect the data above online** in Google sheets (basic instructions [here](#org9bfd28b)):
...
[<sub>Back to top</sub>](#org191c71e)
...
-   *race.after* = incumbent's status in the next consecutive race. See [this](#orgdaa11ed) for categories and coding procedure ([aquí](#org0f0bf6a) la versión en castellano del procedimiento codificador).
...
# Coding procedure for the incumbent's status<a id="orgdaa11ed"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="org0f0bf6a"></a>
...
# Basic instructions to inspect data online:<a id="org9bfd28b"></a>
...
c. Linked data updates about every hour. If a refresh were needed sooner, erase the function in cell A1 and undo the change. [<sub>Back to top</sub>](#org191c71e)
