- [Description of *Recent Mexican Election Vote Returns* repository<a id="org097eb9d"></a>](#orgda2a834)
- [How to cite the data](#org72b9edd)
- [Description paper](#org5df3274)
- [File naming conventions](#org25e8bca)
- [Files in the repository](#org644163c)
  - [Municipal office election returns](#orgeec25b2)
    - [Non-fused ballots (Chihuahua and Nayarit)](#org81603af)
    - [**Inspect data online** in Google sheets](#orgf946a3d)
  - [Congressional election returns](#org9f1ae9c)
  - [Presidential election returns](#org03e2883)
  - [Gubernatorial election returns](#org1aa5ef4)
  - [Other](#org616276f)
- [Historical party performance statistics](#orge56f962)
  - [Backwards predictions](#org8974ca3)
- [Codebook<a id="org0ac77fd"></a>](#org9154a19)
  - [Unit IDs](#orgd5f8332)
  - [Temporal IDs](#orga5563fc)
  - [Voting](#org538c9a9)
  - [Historical performance](#org5b2b8d2)
  - [Candidates and incumbents](#orgeff8ed1)
  - [Other](#org79dda31)
- [Coding procedure for the incumbent's status<a id="org88bbc69"></a>](#orge5b99a7)
- [Procedimiento para codificar el estatus del ocupante<a id="org468ec9f"></a>](#orga7dd1c8)
- [Basic instructions to inspect data online:<a id="org32ce581"></a>](#orge1770e1)
- [Sources](#org1c5ad37)
- [Acknowledgements](#orge61dc54)
...
# Description of *Recent Mexican Election Vote Returns* repository<a id="org097eb9d"></a>
...
-   [`data/aymu1989-on.concurrence.csv`](./data/aymu1989-on.concurrence.csv) = indicators of municipal election concurrence with a gubernatorial, a state assembly, a presidential, or a congressional race since 1989.<a id="org3d9ee41"></a>
...
Basic instructions [here](#org32ce581); data split by approximate decades or groups of states to comply with spreadsheet size limits (400k cells); files have identical columns to ease appending one another off Google drive:
...
-   **Inspect the data above online** in Google sheets (basic instructions [here](#org32ce581)):
...
[<sub>Back to top</sub>](#org097eb9d)
...
-   *race.after* = incumbent's status in the next consecutive race. See [this](#org88bbc69) for categories and coding procedure ([aquí](#org468ec9f) la versión en castellano del procedimiento codificador).
...
# Coding procedure for the incumbent's status<a id="org88bbc69"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="org468ec9f"></a>
...
# Basic instructions to inspect data online:<a id="org32ce581"></a>
...
c. Linked data updates about every hour. If a refresh were needed sooner, erase the function in cell A1 and undo the change. [<sub>Back to top</sub>](#org097eb9d)
