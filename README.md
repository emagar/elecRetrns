- [Description of *Recent Mexican Election Vote Returns* repository<a id="org966e190"></a>](#org4a2f14e)
- [How to cite the data](#org10bcbfe)
- [Description paper](#orgc35442f)
- [File naming conventions](#org42cc9d1)
- [Files in the repository](#org72448d4)
  - [Municipal office election returns](#orgc66bb0e)
    - [Non-fused ballots (Chihuahua and Nayarit)](#org933d348)
    - [**Inspect data online** in Google sheets](#org5699588)
  - [Congressional election returns](#org480bc2a)
  - [Presidential election returns](#orgdf08216)
  - [Gubernatorial election returns](#orgb0566c9)
  - [Other](#orge86aadd)
- [Historical party performance statistics](#org9d5958b)
  - [Backwards predictions](#org0aadef8)
- [Codebook<a id="orgdaa8344"></a>](#orgef9b7a3)
  - [Unit IDs](#org986e5cf)
  - [Temporal IDs](#orgc2ccbdd)
  - [Voting](#org6d8260e)
  - [Historical performance](#org9c11618)
  - [Candidates and incumbents](#org0bd387d)
  - [Other](#org73674c5)
- [Coding procedure for the incumbent's status<a id="org82bbaac"></a>](#org865340f)
- [Procedimiento para codificar el estatus del ocupante<a id="orgd8c4e0e"></a>](#org47c51ea)
- [Basic instructions to inspect data online:<a id="org3ba5b47"></a>](#orgb70f4de)
- [Sources](#org5cea0e9)
- [Acknowledgements](#org26513d2)
...
<sup><sub>2025-12-06</sub></sup> Added new file with election **concurrence** with other races data since 1989 [here](#orgc8fd74f).
...
# Description of *Recent Mexican Election Vote Returns* repository<a id="org966e190"></a>
...
A research note describing the municipal portion of the data (with general relevance to other data in the repository) can be found [here](./papers/data-descriptives/deep-description-05.pdf).
...
-   [`data/aymu1989-on.concurrence.csv`](./data/aymu1989-on.concurrence.csv) = indicators of municipal election concurrence with a gubernatorial, a state assembly, a presidential, or a congressional race since 1989.<a id="orgc8fd74f"></a>
...
Basic instructions [here](#org3ba5b47); data split by approximate decades or groups of states to comply with spreadsheet size limits (400k cells); files have identical columns to ease appending one another off Google drive:
...
-   **Inspect the data above online** in Google sheets (basic instructions [here](#org3ba5b47)):
...
[<sub>Back to top</sub>](#org966e190)
...
-   *race.after* = incumbent's status in the next consecutive race. See [this](#org82bbaac) for categories and coding procedure ([aquí](#orgd8c4e0e) la versión en castellano del procedimiento codificador).
...
# Coding procedure for the incumbent's status<a id="org82bbaac"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="orgd8c4e0e"></a>
...
# Basic instructions to inspect data online:<a id="org3ba5b47"></a>
...
c. Linked data updates about every hour. If a refresh were needed sooner, erase the function in cell A1 and undo the change. [<sub>Back to top</sub>](#org966e190)
