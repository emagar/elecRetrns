- [Description of *Recent Mexican Election Vote Returns* repository<a id="orgd637fec"></a>](#orgebe2a21)
- [How to cite the data](#org1f4bb4f)
- [File naming conventions](#orgd985eca)
- [Files in the repository](#orge6fcdda)
  - [Municipal office election returns](#orgbae1f9e)
    - [Non-fused ballots (Chihuahua and Nayarit)](#orgbb5b775)
    - [**Inspect data online** in Google sheets](#org56cfe40)
  - [Congressional election returns](#org8c095bf)
  - [Presidential election returns](#org4c39626)
  - [Gubernatorial election returns](#orgfc00a7c)
  - [Other](#org499667a)
- [Historical party performance statistics](#org54aae33)
  - [Backwards predictions](#org9062e07)
- [Codebook<a id="orgfca8e7f"></a>](#org13a3249)
  - [Unit IDs](#org4458153)
  - [Temporal IDs](#orgd74789f)
  - [Voting](#orgf5c6461)
  - [Historical performance](#org07244c3)
  - [Candidates and incumbents](#org0f71605)
  - [Other](#orga3e536a)
- [Coding procedure for the incumbent's status<a id="org56aa211"></a>](#org243b6d3)
- [Procedimiento para codificar el estatus del ocupante<a id="orgdaa9b3b"></a>](#org55d587b)
- [Basic instructions to inspect data online:<a id="org2043ede"></a>](#orge555345)
- [Sources](#orgc3d17ca)
- [Acknowledgements](#org602f282)
...
<sup><sub>2023-11-11</sub></sup> [**Codebook**](#orgfca8e7f) updated, with a printable flier.
...
# Description of *Recent Mexican Election Vote Returns* repository<a id="orgd637fec"></a>
...
Basic instructions [here](#org2043ede); data split by approximate decades or groups of states to comply with spreadsheet size limits (400k cells); files have identical columns to ease appending one another off Google drive:
...
-   **Inspect the data above online** in Google sheets (basic instructions [here](#org2043ede)):
...
[<sub>Back to top</sub>](#orgd637fec)
...
-   *race.after* = incumbent's status in the next consecutive race. See [this](#org56aa211) for categories and coding procedure ([aquí](#orgdaa9b3b) la versión en castellano del procedimiento codificador).
...
# Coding procedure for the incumbent's status<a id="org56aa211"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="orgdaa9b3b"></a>
...
# Basic instructions to inspect data online:<a id="org2043ede"></a>
...
c. Linked data updates about every hour. If a refresh were needed sooner, erase the function in cell A1 and undo the change. [<sub>Back to top</sub>](#orgd637fec)
