- [Description of *Recent Mexican Election Vote Returns* repository<a id="orga528c16"></a>](#org0793d87)
- [How to cite the data](#orge97bbfa)
- [File naming conventions](#orgbe36fe1)
- [Files in the repository](#org4c1f984)
  - [Municipal office election returns](#org0dea20b)
  - [Congressional election returns](#orgf3f642d)
  - [Presidential election returns](#org92c0867)
  - [Gubernatorial election returns](#org977e368)
  - [Other](#org2e4f480)
- [Historical party performance statistics](#org815f9eb)
  - [Backwards predictions](#orgb57efe7)
- [Codebook<a id="org185b640"></a>](#orgb448d53)
  - [Unit IDs](#org323d46d)
  - [Temporal IDs](#orga204793)
  - [Voting information](#org2b71ee9)
  - [Historical performance](#orgb696923)
  - [Candidate IDs](#org624050d)
  - [Other](#org47e8c07)
- [Coding procedure for the incumbent's status<a id="orgb336aed"></a>](#org49de931)
- [Procedimiento para codificar el estatus del ocupante<a id="org1de8ca6"></a>](#org138fe07)
- [Basic instructions to inspect data online:<a id="org5bded1d"></a>](#orgda136fe)
- [Sources](#orga5100b3)
- [Acknowledgements](#orgfe50f0b)
...
<sup><sub>2023-06-07</sub></sup> [**Codebook**](#org185b640) updated, with a printable flier.
...
# Description of *Recent Mexican Election Vote Returns* repository<a id="orga528c16"></a>
...
-   **Inspect the data above online** in Google sheets (basic instructions [here](#org5bded1d); data split by approximate decades or groups of states to comply with spreadsheet size limits (400k cells); files have identical columns to ease appending one another off Google drive):
...
-   **Inspect the data above online** in Google sheets (basic instructions [here](#org5bded1d)):
...
[<sub>Back to top</sub>](#orga528c16)
...
-   *race.after* = incumbent's status in the next consecutive race. See [this](#orgb336aed) for categories and coding procedure ([aquí](#org1de8ca6) la versión en castellano del procedimiento codificador).
...
# Coding procedure for the incumbent's status<a id="orgb336aed"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="org1de8ca6"></a>
...
# Basic instructions to inspect data online:<a id="org5bded1d"></a>
...
c. Linked data updates about every hour. If a refresh were needed sooner, erase the function in cell A1 and undo the change. [<sub>Back to top</sub>](#orga528c16)
