- [Description of *Recent Mexican Election Vote Returns* repository<a id="org9e77f03"></a>](#orgd4e8fc6)
- [How to cite the data](#orgb048f05)
- [Description paper](#org68ecaa4)
- [File naming conventions](#org0ffeb60)
- [Files in the repository](#orga15f64c)
  - [Municipal office election returns](#org2f38124)
    - [Non-fused ballots (Chihuahua and Nayarit)](#org574c6a7)
    - [**Inspect data online** in Google sheets](#orga41bc8b)
  - [Congressional election returns](#org69c22ec)
  - [Presidential election returns](#org7dffb64)
  - [Gubernatorial election returns](#orgee893df)
  - [Other](#org5993d18)
- [Historical party performance statistics](#org6e381f0)
  - [Backwards predictions](#orga3ef85d)
- [Codebook<a id="org4efa6dc"></a>](#org1dd6f18)
  - [Unit IDs](#orgcef651e)
  - [Temporal IDs](#org4b3c236)
  - [Voting](#org77de7e9)
  - [Historical performance](#orgb178d50)
  - [Candidates and incumbents](#org783f96b)
  - [Other](#orge490c94)
- [Coding procedure for the incumbent's status<a id="orga18373e"></a>](#org5788d2d)
- [Procedimiento para codificar el estatus del ocupante<a id="orge4bdd7e"></a>](#org458145e)
- [Basic instructions to inspect data online:<a id="org04b2fb0"></a>](#orge0c5325)
- [Sources](#org42b33b0)
- [Acknowledgements](#org257c4f9)
...
<sup><sub>2025-12-06</sub></sup> New file added: municipal election **concurrence** with other races since 1989 [here](#org186a37e).
...
# Description of *Recent Mexican Election Vote Returns* repository<a id="org9e77f03"></a>
...
-   [`data/aymu1989-on.concurrence.csv`](./data/aymu1989-on.concurrence.csv) = indicators of municipal election concurrence with a gubernatorial, a state assembly, a presidential, or a congressional race since 1989.<a id="org186a37e"></a>
...
Basic instructions [here](#org04b2fb0); data split by approximate decades or groups of states to comply with spreadsheet size limits (400k cells); files have identical columns to ease appending one another off Google drive:
...
-   **Inspect the data above online** in Google sheets (basic instructions [here](#org04b2fb0)):
...
[<sub>Back to top</sub>](#org9e77f03)
...
-   *race.after* = incumbent's status in the next consecutive race. See [this](#orga18373e) for categories and coding procedure ([aquí](#orge4bdd7e) la versión en castellano del procedimiento codificador).
...
# Coding procedure for the incumbent's status<a id="orga18373e"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="orge4bdd7e"></a>
...
# Basic instructions to inspect data online:<a id="org04b2fb0"></a>
...
c. Linked data updates about every hour. If a refresh were needed sooner, erase the function in cell A1 and undo the change. [<sub>Back to top</sub>](#org9e77f03)
