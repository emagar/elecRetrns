- [Description of *Recent Mexican Election Vote Returns* repository<a id="orgbea5255"></a>](#org8931a62)
- [How to cite the data](#org1d9b3a1)
- [Description paper](#org19aa230)
- [File naming conventions](#orgfa6b6d6)
- [Files in the repository](#orga6acc22)
  - [Municipal office election returns](#orgc73e447)
    - [Non-fused ballots (Chihuahua and Nayarit)](#org217b8a4)
    - [**Inspect data online** in Google sheets](#org46c2145)
  - [Congressional election returns](#orgad34099)
  - [Presidential election returns](#org11569a6)
  - [Gubernatorial election returns](#orgb8ed4ee)
  - [Other](#org023a695)
- [Historical party performance statistics](#org33c4b6e)
  - [Backwards predictions](#org51355c0)
- [Codebook<a id="orgd76aaa1"></a>](#org0253e80)
  - [Unit IDs](#orgf482784)
  - [Temporal IDs](#org7008262)
  - [Voting](#orgdc373e2)
  - [Historical performance](#org60321cd)
  - [Candidates and incumbents](#org8f1e620)
  - [Other](#orgb8fe1ce)
- [Coding procedure for the incumbent's status<a id="org0d09669"></a>](#org0289aca)
- [Procedimiento para codificar el estatus del ocupante<a id="orgb0f99cb"></a>](#orgbe9226f)
- [Basic instructions to inspect data online:<a id="org01e0235"></a>](#orgc6bc5ba)
- [Sources](#org7602ffb)
- [Acknowledgements](#orgeee7ba9)
...
<sup><sub>2025-12-11</sub></sup> Added a **research note** describing the **municipal elections** portion of the dataset [here](./papers/data-descriptives/deep-description-04-mex-studies.pdf).

<sup><sub>2025-12-06</sub></sup> New file added: municipal election **concurrence** with other races since 1989 [here](#org8340170).
...
# Description of *Recent Mexican Election Vote Returns* repository<a id="orgbea5255"></a>
...
-   [`data/aymu1989-on.concurrence.csv`](./data/aymu1989-on.concurrence.csv) = indicators of municipal election concurrence with a gubernatorial, a state assembly, a presidential, or a congressional race since 1989.<a id="org8340170"></a>
...
Basic instructions [here](#org01e0235); data split by approximate decades or groups of states to comply with spreadsheet size limits (400k cells); files have identical columns to ease appending one another off Google drive:
...
-   **Inspect the data above online** in Google sheets (basic instructions [here](#org01e0235)):
...
[<sub>Back to top</sub>](#orgbea5255)
...
-   *race.after* = incumbent's status in the next consecutive race. See [this](#org0d09669) for categories and coding procedure ([aquí](#orgb0f99cb) la versión en castellano del procedimiento codificador).
...
# Coding procedure for the incumbent's status<a id="org0d09669"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="orgb0f99cb"></a>
...
# Basic instructions to inspect data online:<a id="org01e0235"></a>
...
c. Linked data updates about every hour. If a refresh were needed sooner, erase the function in cell A1 and undo the change. [<sub>Back to top</sub>](#orgbea5255)
