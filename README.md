- [Description of *Recent Mexican Election Vote Returns* repository<a id="org3a6ee77"></a>](#org8fb9751)
- [How to cite the data](#org24c7769)
- [Description paper](#orga2707ec)
- [File naming conventions](#org8aab467)
- [Files in the repository](#org8f0b6f9)
  - [Municipal office election returns](#org5b0cf8c)
    - [Non-fused ballots (Chihuahua and Nayarit)](#orgb31b328)
    - [**Inspect data online** in Google sheets](#org5453acb)
  - [Congressional election returns](#org58cc478)
  - [Presidential election returns](#orgee39320)
  - [Gubernatorial election returns](#org8ce19e8)
  - [Other](#org1d5e41c)
- [Historical party performance statistics](#org8cad6ff)
  - [Backwards predictions](#orgac85113)
- [Codebook<a id="orgf593ad9"></a>](#orgd206127)
  - [Unit IDs](#org299a5b1)
  - [Temporal IDs](#org13b2875)
  - [Voting](#orgcbcf86c)
  - [Historical performance](#orga030838)
  - [Candidates and incumbents](#org94e0a51)
  - [Other](#org196edb0)
- [Coding procedure for the incumbent's status<a id="orgba466f0"></a>](#org6443b34)
- [Procedimiento para codificar el estatus del ocupante<a id="orgb17fa46"></a>](#orge944d1b)
- [Basic instructions to inspect data online:<a id="orga386b25"></a>](#org4255ebd)
- [Sources](#org5b921ab)
- [Acknowledgements](#org5024ae6)
...
<sup><sub>2025-12-11</sub></sup> Added a **research note** describing the **municipal elections** portion of the dataset [here](./papers/data-descriptives/deep-description-06.pdf).

<sup><sub>2025-12-06</sub></sup> New file added: municipal election **concurrence** with other races since 1989 [here](#org85e358e).
...
# Description of *Recent Mexican Election Vote Returns* repository<a id="org3a6ee77"></a>
...
-   [`data/aymu1989-on.concurrence.csv`](./data/aymu1989-on.concurrence.csv) = indicators of municipal election concurrence with a gubernatorial, a state assembly, a presidential, or a congressional race since 1989.<a id="org85e358e"></a>
...
Basic instructions [here](#orga386b25); data split by approximate decades or groups of states to comply with spreadsheet size limits (400k cells); files have identical columns to ease appending one another off Google drive:
...
-   **Inspect the data above online** in Google sheets (basic instructions [here](#orga386b25)):
...
[<sub>Back to top</sub>](#org3a6ee77)
...
-   *race.after* = incumbent's status in the next consecutive race. See [this](#orgba466f0) for categories and coding procedure ([aquí](#orgb17fa46) la versión en castellano del procedimiento codificador).
...
# Coding procedure for the incumbent's status<a id="orgba466f0"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="orgb17fa46"></a>
...
# Basic instructions to inspect data online:<a id="orga386b25"></a>
...
c. Linked data updates about every hour. If a refresh were needed sooner, erase the function in cell A1 and undo the change. [<sub>Back to top</sub>](#org3a6ee77)
