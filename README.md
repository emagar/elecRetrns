- [Description of *Recent Mexican Election Vote Returns* repository<a id="orgc19e292"></a>](#orgd1d79e5)
- [How to cite the data](#orgfd592ef)
- [Description paper](#org8334582)
- [File naming conventions](#org99f1aa9)
- [Files in the repository](#orgdb29336)
  - [Municipal office election returns](#org513d507)
    - [Non-fused ballots (Chihuahua and Nayarit)](#org945e824)
    - [**Inspect data online** in Google sheets](#org91d9818)
  - [Congressional election returns](#org972ee41)
  - [Presidential election returns](#org393d55f)
  - [Gubernatorial election returns](#org8a2bb15)
  - [Other](#orgc0408f1)
- [Historical party performance statistics](#org2911de2)
  - [Backwards predictions](#orgbb55470)
- [Codebook<a id="orgf18d179"></a>](#org9422009)
  - [Unit IDs](#orgb79970f)
  - [Temporal IDs](#org91fa05e)
  - [Voting](#orgb190d9c)
  - [Historical performance](#org5cfa538)
  - [Candidates and incumbents](#orgc2f1755)
  - [Other](#org8afd4ae)
- [Coding procedure for the incumbent's status<a id="org062494f"></a>](#org87d7479)
- [Procedimiento para codificar el estatus del ocupante<a id="org388f0a7"></a>](#orgcc839f3)
- [Basic instructions to inspect data online:<a id="org3792ef6"></a>](#orgb80fa5d)
- [Sources](#org8b1a954)
- [Acknowledgements](#org1c95255)
...
<sup><sub>2025-12-06</sub></sup> New file added: municipal election **concurrence** with other races since 1989 [here](#org99e8dee).
...
# Description of *Recent Mexican Election Vote Returns* repository<a id="orgc19e292"></a>
...
-   [`data/aymu1989-on.concurrence.csv`](./data/aymu1989-on.concurrence.csv) = indicators of municipal election concurrence with a gubernatorial, a state assembly, a presidential, or a congressional race since 1989.<a id="org99e8dee"></a>
...
Basic instructions [here](#org3792ef6); data split by approximate decades or groups of states to comply with spreadsheet size limits (400k cells); files have identical columns to ease appending one another off Google drive:
...
-   **Inspect the data above online** in Google sheets (basic instructions [here](#org3792ef6)):
...
[<sub>Back to top</sub>](#orgc19e292)
...
-   *race.after* = incumbent's status in the next consecutive race. See [this](#org062494f) for categories and coding procedure ([aquí](#org388f0a7) la versión en castellano del procedimiento codificador).
...
# Coding procedure for the incumbent's status<a id="org062494f"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="org388f0a7"></a>
...
# Basic instructions to inspect data online:<a id="org3792ef6"></a>
...
c. Linked data updates about every hour. If a refresh were needed sooner, erase the function in cell A1 and undo the change. [<sub>Back to top</sub>](#orgc19e292)
