- [Description of *Recent Mexican Election Vote Returns* repository<a id="org3095e20"></a>](#org6edf5b4)
- [How to cite the data](#org45c7dae)
- [Description paper](#org783bf92)
- [File naming conventions](#org6278228)
- [Files in the repository](#org19683af)
  - [Municipal office election returns](#orgcf0f6f6)
    - [Non-fused ballots (Chihuahua and Nayarit)](#org185ada4)
    - [**Inspect data online** in Google sheets](#org511bcff)
  - [Congressional election returns](#orgc0db09c)
  - [Presidential election returns](#org1be1d00)
  - [Gubernatorial election returns](#org5e9d6e0)
  - [Other](#orgaec3355)
- [Historical party performance statistics](#org099e162)
  - [Backwards predictions](#org11f10aa)
- [Codebook<a id="orgef59bf6"></a>](#org92b0973)
  - [Unit IDs](#orgbfec07d)
  - [Temporal IDs](#org22ece58)
  - [Voting](#org9f90cc8)
  - [Historical performance](#org2f2728f)
  - [Candidates and incumbents](#org552842c)
  - [Other](#org6baeaa9)
- [Coding procedure for the incumbent's status<a id="org81534bc"></a>](#orged6b45e)
- [Procedimiento para codificar el estatus del ocupante<a id="org9810534"></a>](#org55593e0)
- [Basic instructions to inspect data online:<a id="org87bd6bc"></a>](#org1890f43)
- [Sources](#org4bbb9d3)
- [Acknowledgements](#org16d4473)
...
<sup><sub>2025-12-11</sub></sup> Added a **research note** describing the **municipal elections** portion of the dataset [here](./papers/data-descriptives/deep-description-07.pdf).
...
# Description of *Recent Mexican Election Vote Returns* repository<a id="org3095e20"></a>
...
-   [`data/aymu1989-on.concurrence.csv`](./data/aymu1989-on.concurrence.csv) = indicators of municipal election concurrence with a gubernatorial, a state assembly, a presidential, or a congressional race since 1989.<a id="org63e7326"></a>
...
Basic instructions [here](#org87bd6bc); data split by approximate decades or groups of states to comply with spreadsheet size limits (400k cells); files have identical columns to ease appending one another off Google drive:
...
-   **Inspect the data above online** in Google sheets (basic instructions [here](#org87bd6bc)):
...
[<sub>Back to top</sub>](#org3095e20)
...
-   *race.after* = incumbent's status in the next consecutive race. See [this](#org81534bc) for categories and coding procedure ([aquí](#org9810534) la versión en castellano del procedimiento codificador).
...
# Coding procedure for the incumbent's status<a id="org81534bc"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="org9810534"></a>
...
# Basic instructions to inspect data online:<a id="org87bd6bc"></a>
...
c. Linked data updates about every hour. If a refresh were needed sooner, erase the function in cell A1 and undo the change. [<sub>Back to top</sub>](#org3095e20)
