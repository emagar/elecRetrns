- [Description of *Recent Mexican Election Vote Returns* repository<a id="orgd774456"></a>](#orgc468878)
- [How to cite the data](#org509fb8d)
- [Description paper](#org05b3fef)
- [File naming conventions](#orgdf4ac52)
- [Files in the repository](#org0f445c8)
  - [Municipal office election returns](#org919c792)
    - [Non-fused ballots (Chihuahua and Nayarit)](#org7a77ab2)
    - [**Inspect data online** in Google sheets](#orgfbcb9fe)
  - [Congressional election returns](#orgfbf75ea)
  - [Presidential election returns](#org9c0203f)
  - [Gubernatorial election returns](#orge7cfcd5)
  - [Other](#orged9f932)
- [Historical party performance statistics](#orgb5db056)
  - [Backwards predictions](#orgbd5a392)
- [Codebook<a id="org0e61708"></a>](#org1ae6d89)
  - [Unit IDs](#org1733e91)
  - [Temporal IDs](#org671f73a)
  - [Voting](#orga67d9e7)
  - [Historical performance](#org325e403)
  - [Candidates and incumbents](#org2462eeb)
  - [Other](#org1947a42)
- [Coding procedure for the incumbent's status<a id="orgbb8d2f2"></a>](#orgb00a16e)
- [Procedimiento para codificar el estatus del ocupante<a id="org9cffbfb"></a>](#orgfaf1edd)
- [Basic instructions to inspect data online:<a id="orgf9aaa9b"></a>](#org619b1cc)
- [Sources](#orgba1f007)
- [Acknowledgements](#org54d5a82)
...
<sup><sub>2025-12-06</sub></sup> Added new file with election **concurrence** with other races data since 1989 [here](#org2c64854).
...
# Description of *Recent Mexican Election Vote Returns* repository<a id="orgd774456"></a>
...
-   [`data/aymu1989-on.concurrence.csv`](./data/aymu1989-on.concurrence.csv) = indicators of municipal election concurrence with a gubernatorial, a state assembly, a presidential, or a congressional race since 1989.<a id="org2c64854"></a>
...
Basic instructions [here](#orgf9aaa9b); data split by approximate decades or groups of states to comply with spreadsheet size limits (400k cells); files have identical columns to ease appending one another off Google drive:
...
-   **Inspect the data above online** in Google sheets (basic instructions [here](#orgf9aaa9b)):
...
[<sub>Back to top</sub>](#orgd774456)
...
-   *race.after* = incumbent's status in the next consecutive race. See [this](#orgbb8d2f2) for categories and coding procedure ([aquí](#org9cffbfb) la versión en castellano del procedimiento codificador).
...
# Coding procedure for the incumbent's status<a id="orgbb8d2f2"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="org9cffbfb"></a>
...
# Basic instructions to inspect data online:<a id="orgf9aaa9b"></a>
...
c. Linked data updates about every hour. If a refresh were needed sooner, erase the function in cell A1 and undo the change. [<sub>Back to top</sub>](#orgd774456)
