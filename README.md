- [Description of *Recent Mexican Election Vote Returns* repository<a id="org8faf302"></a>](#org15cdadc)
- [How to cite the data](#org5a6b112)
- [File naming conventions](#org7b29791)
- [Files in the repository](#orga77da34)
  - [Municipal office election returns](#org5bbaff2)
    - [Non-fused ballots (Chihuahua and Nayarit)](#org9de0c54)
    - [**Inspect data online** in Google sheets](#org27a09ff)
  - [Congressional election returns](#org093692c)
  - [Presidential election returns](#orgb7831e2)
  - [Gubernatorial election returns](#org6dd734d)
  - [Other](#orgc6e0e72)
- [Historical party performance statistics](#orgaf31b22)
  - [Backwards predictions](#orgbfcac32)
- [Codebook<a id="orgc439495"></a>](#org765c41b)
  - [Unit IDs](#orgfe1c9f2)
  - [Temporal IDs](#org7cdf6ad)
  - [Voting](#orgcc26d7b)
  - [Historical performance](#orgdfb5291)
  - [Candidates and incumbents](#org8d4aeef)
  - [Other](#org24b3797)
- [Coding procedure for the incumbent's status<a id="org6e63159"></a>](#orgeaee482)
- [Procedimiento para codificar el estatus del ocupante<a id="orga50bf11"></a>](#org667bc3a)
- [Basic instructions to inspect data online:<a id="org5a68743"></a>](#org38cefcc)
- [Sources](#org8e43262)
- [Acknowledgements](#orged2ad8f)
...
<sup><sub>2023-11-11</sub></sup> [**Codebook**](#orgc439495) updated, with a printable flier.
...
# Description of *Recent Mexican Election Vote Returns* repository<a id="org8faf302"></a>
...
Basic instructions [here](#org5a68743); data split by approximate decades or groups of states to comply with spreadsheet size limits (400k cells); files have identical columns to ease appending one another off Google drive:
...
-   **Inspect the data above online** in Google sheets (basic instructions [here](#org5a68743)):
...
[<sub>Back to top</sub>](#org8faf302)
...
-   *race.after* = incumbent's status in the next consecutive race. See [this](#org6e63159) for categories and coding procedure ([aquí](#orga50bf11) la versión en castellano del procedimiento codificador).
...
# Coding procedure for the incumbent's status<a id="org6e63159"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="orga50bf11"></a>
...
# Basic instructions to inspect data online:<a id="org5a68743"></a>
...
c. Linked data updates about every hour. If a refresh were needed sooner, erase the function in cell A1 and undo the change. [<sub>Back to top</sub>](#org8faf302)
