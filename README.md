- [Description of *Recent Mexican Election Vote Returns* repository<a id="org9c026e0"></a>](#orgc7ea717)
- [How to cite the data](#org083c3a7)
- [File naming conventions](#org103774d)
- [Files in the repository](#orgbdd021e)
  - [Municipal office election returns](#orgba1f95b)
    - [Non-fused ballots (Chihuahua and Nayarit)](#org27a3e82)
    - [**Inspect data online** in Google sheets](#orgced0d83)
  - [Congressional election returns](#org9230391)
  - [Presidential election returns](#orga42786a)
  - [Gubernatorial election returns](#org3f3e367)
  - [Other](#org3a0a7b4)
- [Historical party performance statistics](#org4fee2df)
  - [Backwards predictions](#org30927fa)
- [Codebook<a id="orgb69b045"></a>](#orgd01b493)
  - [Unit IDs](#org2c2057d)
  - [Temporal IDs](#org81e6df6)
  - [Voting](#org71dd6fc)
  - [Historical performance](#orgfb37cf5)
  - [Candidates and incumbents](#orgee7e290)
  - [Other](#org6c46ce9)
- [Coding procedure for the incumbent's status<a id="orge209ddd"></a>](#orgbf06bf1)
- [Procedimiento para codificar el estatus del ocupante<a id="org5ec9cc3"></a>](#orgd60e462)
- [Basic instructions to inspect data online:<a id="orgab14350"></a>](#orga7ed55f)
- [Sources](#orge1d93b8)
- [Acknowledgements](#org225d11a)
...
<sup><sub>2023-11-11</sub></sup> [**Codebook**](#orgb69b045) updated, with a printable flier.
...
# Description of *Recent Mexican Election Vote Returns* repository<a id="org9c026e0"></a>
...
Basic instructions [here](#orgab14350); data split by approximate decades or groups of states to comply with spreadsheet size limits (400k cells); files have identical columns to ease appending one another off Google drive:
...
-   **Inspect the data above online** in Google sheets (basic instructions [here](#orgab14350)):
...
[<sub>Back to top</sub>](#org9c026e0)
...
-   *race.after* = incumbent's status in the next consecutive race. See [this](#orge209ddd) for categories and coding procedure ([aquí](#org5ec9cc3) la versión en castellano del procedimiento codificador).
...
# Coding procedure for the incumbent's status<a id="orge209ddd"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="org5ec9cc3"></a>
...
# Basic instructions to inspect data online:<a id="orgab14350"></a>
...
c. Linked data updates about every hour. If a refresh were needed sooner, erase the function in cell A1 and undo the change. [<sub>Back to top</sub>](#org9c026e0)
