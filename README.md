- [Description of *Recent Mexican Election Vote Returns* repository](#orge7335e9)
- [Files in the repository and how to cite them](#org55f70a8)
- [Codebook](#org23347bc)
- [Coding procedure for the incumbent's status<a id="orgc41beee"></a>](#org897e8f5)
- [Procedimiento para codificar el estatus del ocupante<a id="org4aa4e44"></a>](#org3c84d3e)
- [Sources](#org04532c9)
- [Acknowledgements](#orgd4bde86)
...
-   [`data/aymu1989-present.csv`](./data/aymu1989-present.csv) test
...
-   `data/aymu1989-present.coalSplit.csv` = pre-processed version of the above (starting in 1989) so that coalition votes appear properly split among its members.
-   `data/aymu1989-present.incumbents.csv` = names of municipal election winning candidates (*presidente municipal* only) since 1989. Includes reelection status since 2018.
...
-   `data/seed2012-on.candidates.csv` = names of all senatorial candidates in states and party lists since 2012.
-   `data/goed1961-on.csv` = updated to 2018
...
-   *race.after* = incumbent's status in the subsequent race. See [this](#orgc41beee) for categories and coding procedure ([aquí](#org4aa4e44) la versión en español del procedimiento codificador).
...
# Coding procedure for the incumbent's status<a id="orgc41beee"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="org4aa4e44"></a>
