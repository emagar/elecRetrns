- [Description of *Recent Mexican Election Vote Returns* repository<a id="org1ac0298"></a>](#orga61c6c8)
- [How to cite the data](#org009c597)
- [File naming conventions](#orgf55705c)
- [Files in the repository](#org82c1155)
  - [Municipal office election returns](#org45f813b)
    - [Non-fused ballots (Chihuahua and Nayarit)](#org52dfc19)
    - [**Inspect data online** in Google sheets](#orgce75aba)
  - [Congressional election returns](#orge8c29e8)
  - [Presidential election returns](#orgce31524)
  - [Gubernatorial election returns](#orgb1c5361)
  - [Other](#org2d140bb)
- [Historical party performance statistics](#orga1df944)
  - [Backwards predictions](#orga888c1d)
- [Codebook<a id="orga70b3a1"></a>](#orgcc5808c)
  - [Unit IDs](#org81c2533)
  - [Temporal IDs](#org6f50676)
  - [Voting](#org4698e0e)
  - [Historical performance](#org3c46159)
  - [Candidates and incumbents](#org290b3f7)
  - [Other](#org7b53ece)
- [Coding procedure for the incumbent's status<a id="org3a96a4b"></a>](#orgcefa95d)
- [Procedimiento para codificar el estatus del ocupante<a id="org90d7b23"></a>](#org7c4df44)
- [Basic instructions to inspect data online:<a id="orge506e94"></a>](#org31d71f7)
- [Sources](#org88f8841)
- [Acknowledgements](#org59c6e2b)
...
<sup><sub>2023-11-11</sub></sup> [**Codebook**](#orga70b3a1) updated, with a printable flier.
...
# Description of *Recent Mexican Election Vote Returns* repository<a id="org1ac0298"></a>
...
Basic instructions [here](#orge506e94); data split by approximate decades or groups of states to comply with spreadsheet size limits (400k cells); files have identical columns to ease appending one another off Google drive:
...
-   **Inspect the data above online** in Google sheets (basic instructions [here](#orge506e94)):
...
[<sub>Back to top</sub>](#org1ac0298)
...
-   *race.after* = incumbent's status in the next consecutive race. See [this](#org3a96a4b) for categories and coding procedure ([aquí](#org90d7b23) la versión en castellano del procedimiento codificador).
...
# Coding procedure for the incumbent's status<a id="org3a96a4b"></a>
...
# Procedimiento para codificar el estatus del ocupante<a id="org90d7b23"></a>
...
# Basic instructions to inspect data online:<a id="orge506e94"></a>
...
c. Linked data updates about every hour. If a refresh were needed sooner, erase the function in cell A1 and undo the change. [<sub>Back to top</sub>](#org1ac0298)
