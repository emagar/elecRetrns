...
replace efec=pan+pri+prd+oth3a+oth3b+oth4 if edon==24 & (yr==2000 | yr==2006)
...
sort edon yr ife
outsheet edon inegi ife mun yr trienio trien mgpri mgpan mgprd mgoth using c:\data\1new\mapas\municipio\dataFrStata, comma replace
restore
