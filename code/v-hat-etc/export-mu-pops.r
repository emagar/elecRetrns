...
setwd(sd)
tmp.est <- tmp.est[, moveme(colnames(tmp.est), "ord before y1995; seccion before y1995")]
write.csv(tmp.est, file="censo/p18se-proj-w-interlog.csv", row.names=FALSE)
...
dim(nm)
dim(tmp.est)
p18mun <- cbind(edon=nm$edon, inegi=nm$inegi, ife=nm$ife, mun=nm$mun, tmp.est) ## add inegi
p18mun$y1995 <- ave(p18mun$y1995, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun$y1996 <- ave(p18mun$y1996, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun$y1997 <- ave(p18mun$y1997, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun$y1998 <- ave(p18mun$y1998, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun$y1999 <- ave(p18mun$y1999, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun$y2000 <- ave(p18mun$y2000, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun$y2001 <- ave(p18mun$y2001, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun$y2002 <- ave(p18mun$y2002, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun$y2003 <- ave(p18mun$y2003, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun$y2004 <- ave(p18mun$y2004, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun$y2005 <- ave(p18mun$y2005, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun$y2006 <- ave(p18mun$y2006, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun$y2007 <- ave(p18mun$y2007, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun$y2008 <- ave(p18mun$y2008, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun$y2009 <- ave(p18mun$y2009, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun$y2010 <- ave(p18mun$y2010, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun$y2011 <- ave(p18mun$y2011, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun$y2012 <- ave(p18mun$y2012, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun$y2013 <- ave(p18mun$y2013, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun$y2014 <- ave(p18mun$y2014, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun$y2015 <- ave(p18mun$y2015, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun$y2016 <- ave(p18mun$y2016, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun$y2017 <- ave(p18mun$y2017, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun$y2018 <- ave(p18mun$y2018, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun$y2019 <- ave(p18mun$y2019, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun$y2020 <- ave(p18mun$y2020, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun$y2021 <- ave(p18mun$y2021, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun$y2022 <- ave(p18mun$y2022, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun$y2023 <- ave(p18mun$y2023, as.factor(p18mun$inegi), FUN=function(x) sum(x, na.rm=TRUE))
p18mun <- p18mun[duplicated(p18mun$inegi)==FALSE,]
p18mun <- p18mun[order(p18mun$inegi),]
...
## Export  ##
#############
## This has se-level projections of p18 aggregated at mu-level
write.csv(x=p18mun, file="/home/eric/Dropbox/data/elecs/MXelsCalendGovt/censos/data/pob18/p18mu-for-compos-var-seccion-censos.csv", row.names=FALSE)

## This exports se-level p18 projections
tmp <- cbind(ord=nm$ord, seccion=nm$seccion, edon=nm$edon, inegi=nm$inegi, tmp.est)
write.csv(x=tmp, file="/home/eric/Dropbox/data/elecs/MXelsCalendGovt/censos/data/pob18/p18se-projections.csv", row.names=FALSE)

## Export resecc-manipulated se-level p18
setwd(sd)
tmp.est[1,]
write.csv(tmp.est, file="censo/p18mu-from-se-level-projection-aggregates.csv", row.names=FALSE)
## write.csv(tmp.est, file="censo/p18se-proj-w-interlog-manip-for-resecc.csv", row.names=FALSE)

## 2feb2024: if above works, below should be useless --- earlier attempts
