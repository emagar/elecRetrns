...
\begin{itemize}
\item The consistency of the darker green bars, representing incumbents who successfully won reelection, is striking: approximately 21 percent overall, with a variation of only $\pm$ 3 percentage points across parties other than the PRD---which was on its way out after the reform. At first glance, a one-in-five reelection rate may not appear particularly high. However, the combined total of both green-shaded bars captures officeholders displaying static ambition \citep{schlesinger.1966} regardless of electoral success: roughly 38 percent overall, with greater variation.
