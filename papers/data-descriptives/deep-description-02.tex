...
I offer a glimpse of the main parties in the period. Mexican parties operate in a hyper-regulated electoral environment. Law, setting up formidable entry barriers, gives the federal and the state election regulatory boards ample powers over party life and campaigns \citep{estevez.ref2007.2007}. Some regulation, such as party registration, is decades-old: an institution adopted by the PRI at the peak of hegemony to deter defectors, whereby any party with fewer than the 3-percent vote threshold not only earns no proportional representation seats---it also ceases to exist legally. Another big chunk dates from the 1990s, when a system of mostly private (if undisclosed) party and campaign finance was replaced overnight with mostly public (and lavish) subsidies \citep{poire.Money2005}. The allotment, which is proportional to the party's vote share in the last election, is given to party leaders with discretion on spending. With formidable carrots and sticks, discipline to the party leadership comes as no surprise. 

\subsection{Major parties}

In broad chronological sequence, single-party hegemony gave way to a three-party, competitive system at the end of the 20th century. Then, in a critical election two decades later, a new dominant party, Morena, left the former major parties in shambles. 
