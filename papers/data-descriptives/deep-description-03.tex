...
% \footnote{Early election scholars paid attention to federal elections for which vote returns have been rather well-organized and systematically available in public sources \citep[eg.][]{gomezTagle.Estadisticas1990, segovia.dientes-sierra1983, molinar.1991a, segovia.els1979}. Discussion of state and municipal races was anecdotal at best due to data unavailability. The respository where the present dataset is distributed includes federal election vote returns too. This note centers in municipal elections only.} 
...
Elections in the PRI-era were never free and fair. They were not fabrications either, but a heterogeneous mix of genuine mobilization, daunting obstacles to opponents, and blatant fraud \citep{molinar.1991a,cantuCSG2019apsr,magaloni.2006}. Democratization changed this. Major parties set up an autonomous election board with formidable authority where they could check one another, levelling the field \citep{estevez.magar.rosas.2008}. AMLO's failure to concede in the 2006 presidential race was never supported by compelling evidence of wrong-doing \citep{klesner.FCHelections.2007}.

Fraud was never fully eliminated, as probably occurs in any democracy. Cantú's \citeyearpar{cantuContiguas2014ajps} systematic study of ``contiguous'' polling stations in the 2010 local races, where most distrust remains, detected few and exceptional irregularities. Since major-parties had equal opportunity at it when the circumstances arose, fraud cancelled-out in the aggregate. This dataset includes elections since 1979, offering leverage to compare and evaluate pre- and post-1997 municipal elections.
...
\begin{table}
  ...
  \begin{tabular}{crl}
    ...
    2024--26  &  28 &  \\ \hline
  \end{tabular} 
  \caption{Municipal glass ceilings: elected female municipal presidents}\label{tab:fem}
\end{table}
...
The dataset opens up the study of consecutive reelection since adoption \citep{motolinia-reel-pork2021,lucardi.rosas.Incumbency.2016}. Figure \ref{F:reel} portrays party reelection rates in the 2018--2023 period contingent on the status of the outgoing municipal president. Interesting patterns emerge. 

\begin{itemize}
\item The regularity of the darker green bars of officers reelected is notable, 21 percent altogether $\pm$ 3 percent. One in five reelected presidents is not an impressive score at first sight. And the sum of green-shaded bars quantifies officers with static ambition regardless of success \citep{schlesinger.1966}: 38 percent of all, with more inter-party variance.

\item Red-shaded bars include executive officers who reelected in the 2018 cycle and could not run again for a third term. Since they demonstrated static ambition in the past, term-limited presidents should be included with the green to gauge the attractiveness of municipal reelection. By the second post-reform cycle, three out of five mayors sought to reelect. This is a more meaningful measure. The 58 percent total among Morena's incumbents is striking, as the national leadership chose in 2025 to cancel the reelection experiment by 2030. 

\item The blue-shaded group reports incumbents who retired, leaving 38 percent of seats open on average. The nature of the withdrawal is unfortunately not in the data--whether they abandoned of their own will or were denied renomination by the party. I hope to get a better sense of this information in future revisions of the dataset.
\end{itemize}
  
\section{The electoral calendar}
...
The distributed dataset covers one half-century of recent Mexican electoral history, reporting vote returns for 35,528 non-missing municipal races across the states. The units of observation in the time-series cross-section are municipality--election years, offering perspective to describe and analyze patterns of sub-national and sub-state partisan support.   

Data also include the names of 24,088 elected municipal presidents since the 1990s.

Also the names of xxxx elected municipal presidents. 
 20086
+ 4051
-   49 unelected
------
...
The sex of 24077 is known.

Wealth of systematized data. 
