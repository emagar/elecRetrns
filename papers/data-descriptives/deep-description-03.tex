...
Another portion of the dataset, included in the file

\begin{itemize}
\item \verb|data/aymu1989-on.incumbents.csv|
\end{itemize}

\noindent places the focus on elected municipal presidents. 
...
\begin{table}
  ...
  \begin{tabular}{crl}
    ...
    2024--26  &  28 &  \\ \hline
  \end{tabular} 
  \caption{Municipal glass ceilings: elected female municipal presidents}
\end{table}
