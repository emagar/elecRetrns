...
The final stage portrayed corresponds to the collapse of the party system that brought electoral democracy to Mexico. Formerly PRI, AMLO split into PRD early on. Twice beaten, he gambled his way out of a party split between his and others, founding Morena, and winning his third bid for the presidency in 2018 in a landslide. The rise in municipal was also slower, as Morena mobilized cities first. But his rise was formidable, and managed to realign municipal elites away from the PRI.   

Partidocracia for two decades. Then Morena split from left, winning the 2018 presidential race in a critical race. Three parties imploded, eventually contending en bloc in 2021 and 2024. Morena is the new dominant party, in a context of increased fragmentiation. PRI elites that had not migrated finally did so, leaving the former Goliath in shambles.
